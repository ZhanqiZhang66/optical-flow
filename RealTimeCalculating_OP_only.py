...
video_idx = r"D:\Trial 161 first 30sec"
...
while (cap.isOpened()):
    with open(output_data_name, 'a') as csv_file:
        ...
        iMovement = np.mean([i for i in flattened_bluebox if i > iThreshold + 3* iThresholdstd])
        ...
        info = {
            "frames": count,
            "number of Movements": iCountMovement[count] * iMovement
